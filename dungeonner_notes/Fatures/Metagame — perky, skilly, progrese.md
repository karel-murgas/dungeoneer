...
| Cyberware                          | Typ | Cena | Efekt                                                                                                                                                                                                | Je možné hned implementovat |
| ---------------------------------- | --- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| Neuronová ochrana (mozek)          | (A) | 10   | **Zabrání efektu ICE** — udělá z ICE uzlu neutral uzel. Musí se ale stihnout aktivovat během warning zprávy, jinak energie přijde vniveč. 2 levely, kadžý umožňuje 1 použití v rámci stejné minihry. | Ano                         |
| Smartlink (oči)                    | (P) | 0    | **Bonus při criticalu - střelba**  — Dává na 1 kolo stun                                                                                                                                             | Ano                         |
| Svalové implantáty (ruce)          | (P) | 0    | **Bonus při criticalu - melee**  — Dává krvácení / zkrat (organiční vs mechaničtí nepřátelé) ve výši 30% původního zranění za kolo                                                                   | Ano                         |
| Skener citlivých míst (oči)        | (A) | 2    | **Zrychlí ručičku** při aimu o 20 %, **zvýší damage** o 20 %.                                                                                                                                        | Ano                         |
| Chameleoní kůže (tělo)             | (A) | 2    | **Neviditelnost** — stojí energii za každé kolo, zruší se útokem nebo hackem.                                                                                                                        | Ano                         |
| Přepěťové kontakty na dlani (ruce) | (A) | 15   | **Otevírání tajných chodeb** — stojí energii za použití zvenku.                                                                                                                                      | Ne                          |
| Zesílení kostry (tělo)             | (P) | 0    | **Odemknutí zbroje** — bez toho zbroj nejde obléci                                                                                                                                                   | Ano                         |
| Protokol samopalu (mozek)          | (P) | 0    | **Odemknutí SMG** — bez toho má SMG poloviční přesnost; 2. a 3. level umožnují vylepšování zbraně v rámci běhu                                                                                       | Ano                         |
| Protokol brokovnice (mozek)        | (P) | 0    | **Odemknutí brokovnice** — bez toho má brokovnice poloviční dmg; 2. a 3. level umožnují vylepšování zbraně v rámci běhu                                                                              | Ano                         |
| Protokol pušky (mozek)             | (P) | 0    | **Odemknutí pušky** — bez toho má puška poloviční dmg; 2. a 3. level umožnují vylepšování zbraně v rámci běhu                                                                                        | Ano                         |
| Protokol energomeče (mozek)        | (P) | 0    | **Odemknutí energomeče** — bez toho má energomeč poloviční dmg; 2. a 3. level umožnují vylepšování zbraně v rámci běhu                                                                               | Ano                         |
| Mechanické rameno (ruka)           | (P) | 0    | **Odemknutí granátů** — Bez toho nejdou použít                                                                                                                                                       | Ne                          |
| Schrána ve stehně (nohy)           | (A) | 10   | **Past** — nastražíš na políčko, kdo do ní vstoupí dostane dmg.                                                                                                                                      | Ne                          |
| Kompenzátory zpětného rázu (ruka)  | (A) | 10   | **Strip armor** — příští zásah sníží armor cíle o 1, ale má o 20% nižší přesnost. Má 2 levely (druhý level snižuje o 2 při 20% ztrátě přesnosti).                                                    | Ano                         |
| Reflexní vlákna (nohy)             | (A) | 2    | **Pohyb a střelba** (aktivní, zadarmo) — provedeš obojí, ale s poloviční přesností.                                                                                                                  | Ano                         |
| Elektronické čočky (oči)           | (P) | 0    | Vyšší **dohled** o 1. Dojde tím k asymetrii, kdy hráč vidí dál než nepřátelé. Měl by mít možnost opustit fight bez generování heatu.                                                                 | Ano                         |
| Nanoboti (tělo)                    | (A) |      | **Heal** (vyléčí 5 nebo 10?) — sníží přesnost na příští fight o 20 % (kumulativně).                                                                                                                  | Ano                         |
| Analytický okruh (mozek)           | (P) | 0    | **Network scan** Zviditelní loot při hackovací minihře (které náboje, která zbraň, ...) - více levelů (1. = heal, 2. = munice, 3. = zbraně)                                                          | Ano                         |


Některé perky mohou mít **více levelů**.

Zbraňové perky umožňují vylepšovat zbraně, pokud ji hráč najde v bedně podruhé, tak se zkombinuje s tou co už má a dá nánoje a malý bonus (dmg, přesnost nebo podobně) - max level zbraně odpovídá max levelu perku, jinak dává jen náboje, jako dosud.
