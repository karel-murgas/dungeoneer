...
| ---------------------------------- | --- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| Neuronová ochrana (mozek)          | (A) | 10   | **Zabrání efektu ICE** — udělá z ICE uzlu neutral uzel. Musí se ale stihnout aktivovat během warning zprávy, jinak energie přijde vniveč. 2 levely, každý umožňuje 1 použití v rámci stejné minihry. | Ne                          |
